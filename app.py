...
if st.session_state.tracking:
    ...
    with tab_main:
        try:
            ...
            st.markdown(f"<div style='text-align:left; font-size:20px; font-weight:700; margin-top:16px;'>P{selected_period} — First Shot After Faceoff</div>", unsafe_allow_html=True)
            ...
            st.markdown(f"<div style='text-align:left; font-size:20px; font-weight:700; margin-top:16px;'>P{selected_period} — 2-Min SOG Buckets</div>", unsafe_allow_html=True)
            ...
            st.divider()
            st.markdown(f"<div style='text-align:left; font-size:20px; font-weight:700; margin-top:16px;'>P{selected_period} — Goals</div>", unsafe_allow_html=True)
